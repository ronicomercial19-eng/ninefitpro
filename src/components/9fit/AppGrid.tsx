      ...
      <div className="grid grid-cols-3 gap-3">
        {apps.map((app) => (
          <button
            ...
            className="aspect-square bg-card border border-border rounded-sm flex flex-col items-center justify-center gap-2 hover:bg-muted hover:border-primary/30 transition-all duration-200"
          >
